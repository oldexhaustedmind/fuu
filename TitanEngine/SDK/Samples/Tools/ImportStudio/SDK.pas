...
{TitanEngine.Importer.functions}
  ...
  function ImporterIsForewardedAPI(hProcess:THandle; APIAddress:LongInt): boolean; stdcall;  external 'TitanEngine.dll' name 'ImporterIsForewardedAPI';
