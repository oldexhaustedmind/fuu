...
void cbFindPatterns(){
	...
	dtPattern1BPXAddress = (void*)Find((void*)(fdLoadedBase + fdEntryPoint), cSearchSize, &dtPattern1[0], dtPattern1Size, &glWildCard);
	...
	dtPattern2BPXAddress = (void*)Find((void*)(fdLoadedBase + fdEntryPoint), cSearchSize, &dtPattern2[0], dtPattern2Size, &glWildCard);
	if(dtPattern2BPXAddress != NULL){
		SetBPX((long)dtPattern2BPXAddress, UE_BREAKPOINT, dtPattern2CallBack);
	}

	dtPattern3BPXAddress = (void*)Find((void*)(fdLoadedBase + fdEntryPoint), cSearchSize, &dtPattern3[0], dtPattern3Size, &glWildCard);
	...
	dtPattern4BPXAddress = (void*)Find((void*)(fdLoadedBase + fdEntryPoint), cSearchSize, &dtPattern4[0], dtPattern4Size, &glWildCard);
	...
	dtPattern5BPXAddress = (void*)Find((void*)(fdLoadedBase + fdEntryPoint), cSearchSize, &dtPattern5[0], dtPattern5Size, &glWildCard);
	if(dtPattern5BPXAddress != NULL){
		...
		dtPattern51BPXAddress = (void*)Find((void*)(fdLoadedBase + fdEntryPoint), cSearchSize, &dtPattern51[0], dtPattern51Size, &glWildCard);
	...
	if(fdFileIsDll){
		dtPattern6BPXAddress = (void*)Find((void*)(fdLoadedBase + fdEntryPoint), cSearchSize, &dtPattern6[0], dtPattern6Size, &glWildCard);
